...
export interface OnuDevice {
  ...
  // Last RX snapshot before offline
...
export const olts: OltDevice[] = [
  ...
  },
  {
    ...
    memory: 35,
    temperature: 38,
    lastSync: "2024-01-16T09:55:00Z",
    uplinkStatus: "Standby",
    uplinkPort: "10GE0/0/2",
    ponPortCount: 4,
  },
  {
...
export const onus: OnuDevice[] = [
  {
    ...
    oltId: "olt-01",
    onuNo: "1/1/1",
    description: "Acme Corp - HQ",
    distance: "1.24 km",
    signalLevel: -18.5,
    txPower: 2.5,
    status: "Online",
    macAddress: "00:1A:2B:3C:4D:5E",
    clientMac: "A4:C3:F0:85:12:33",
    customerName: "Acme Corp",
    lastSync: "Just now",
    bandwidth: "1G/1G",
    lastLogoutTime: "N/A",
    lastLogoutReason: "N/A",
    onlineDuration: "12d 4h 32m",
    ponPort: "PON-1",
    vlanId: 100,
    oltPort: "GPON-0/1/0",
  ...
  },
  {
    ...
    oltId: "olt-01",
    onuNo: "1/1/2",
    description: "TechStart Office",
    distance: "2.10 km",
    signalLevel: -22.1,
    txPower: 2.1,
    status: "Online",
    macAddress: "00:1A:2B:3C:4D:5F",
    clientMac: "A4:C3:F0:85:12:34",
    customerName: "TechStart Inc",
    lastSync: "Just now",
    bandwidth: "500M/500M",
    lastLogoutTime: "2024-01-15 14:22:00",
    lastLogoutReason: "Admin Reboot",
    onlineDuration: "5d 2h 10m",
    ponPort: "PON-1",
    vlanId: 200,
    oltPort: "GPON-0/1/0",
    lastOfflineRxPower: -25.3,
    signalStability: "Stable",
    onuType: "GPON",
  },
  {
    ...
    clientMac: "A4:C3:F0:85:12:35",
    customerName: "Global Logistics",
    lastSync: "5m ago",
    bandwidth: "1G/1G",
    lastLogoutTime: "2024-01-16 09:10:00",
    lastLogoutReason: "Signal Lost",
    onlineDuration: "1d 1h 5m",
    ponPort: "PON-2",
    vlanId: 300,
    oltPort: "GPON-0/2/0",
    lastOfflineRxPower: -30.1,
    signalStability: "High Loss",
    onuType: "GPON",
  },
  {
    id: "onu-004",
    ...
    clientMac: "A4:C3:F0:85:12:36",
    customerName: "City Library",
    lastSync: "Just now",
    bandwidth: "2G/2G",
    lastLogoutTime: "N/A",
    lastLogoutReason: "N/A",
    onlineDuration: "45d 10h 20m",
    ponPort: "PON-1",
    vlanId: 400,
    oltPort: "GPON-0/1/0",
    lastOfflineRxPower: null,
  ...
  },
  {
    ...
    oltId: "olt-05",
    onuNo: "1/3/1",
    description: "Cafe Branch",
    distance: "3.20 km",
    signalLevel: -40.0,
    txPower: -5.0,
    status: "Offline",
    macAddress: "00:1A:2B:3C:4D:62",
    clientMac: "A4:C3:F0:85:12:37",
    customerName: "Westside Cafe",
    lastSync: "2h ago",
    bandwidth: "100M/100M",
    lastLogoutTime: "2024-01-18 11:45:00",
    lastLogoutReason: "Power Loss",
    onlineDuration: "N/A",
    ponPort: "PON-3",
    vlanId: 500,
    oltPort: "GPON-0/3/0",
    lastOfflineRxPower: -38.5,
    signalStability: "Offline",
    onuType: "GPON",
  },
  {
    id: "onu-006",
    ...
    clientMac: "A4:C3:F0:85:12:38",
    customerName: "Downtown Medical",
    lastSync: "Just now",
    bandwidth: "1G/1G",
    lastLogoutTime: "N/A",
    lastLogoutReason: "N/A",
    onlineDuration: "30d 5h 12m",
    ponPort: "PON-1",
    vlanId: 100,
    oltPort: "GPON-0/1/0",
    lastOfflineRxPower: null,
  ...
  },
  {
    ...
    clientMac: "A4:C3:F0:85:12:39",
    customerName: "Sunrise Bakery",
    lastSync: "Just now",
    bandwidth: "200M/200M",
    lastLogoutTime: "2024-01-10 08:30:00",
    lastLogoutReason: "Admin Reboot",
    onlineDuration: "8d 14h 22m",
    ponPort: "PON-1",
    vlanId: 200,
    oltPort: "EPON-0/1/0",
    lastOfflineRxPower: -27.0,
    signalStability: "Weak Signal",
    onuType: "EPON",
  },
  {
    id: "onu-008",
    oltId: "olt-02",
    onuNo: "1/2/2",
    description: "Apt Complex",
    distance: "1.90 km",
    signalLevel: -21.0,
    txPower: 2.0,
    status: "Online",
    macAddress: "00:1A:2B:3C:4D:65",
    clientMac: "A4:C3:F0:85:12:3A",
    customerName: "Oceanview Apartments",
    lastSync: "Just now",
    bandwidth: "1G/1G",
    lastLogoutTime: "N/A",
    lastLogoutReason: "N/A",
    onlineDuration: "100d 2h 45m",
    ponPort: "PON-2",
    vlanId: 300,
    oltPort: "GPON-0/2/0",
    lastOfflineRxPower: null,
  ...
  },
  {
    ...
    clientMac: "A4:C3:F0:85:12:3B",
    customerName: "Valley High School",
    lastSync: "12m ago",
    bandwidth: "500M/500M",
    lastLogoutTime: "2024-01-17 15:20:00",
    lastLogoutReason: "Signal Lost",
    onlineDuration: "10h 5m",
    ponPort: "PON-1",
    vlanId: 400,
    oltPort: "GPON-0/1/0",
    lastOfflineRxPower: -31.5,
    signalStability: "High Loss",
    onuType: "GPON",
  },
  {
    ...
    oltId: "olt-06",
    onuNo: "1/1/1",
    description: "Corp Tower",
    distance: "0.50 km",
    signalLevel: -16.4,
    txPower: 2.8,
    status: "Online",
    macAddress: "00:1A:2B:3C:4D:67",
    clientMac: "A4:C3:F0:85:12:3C",
    customerName: "Enterprise Towers",
    lastSync: "Just now",
    bandwidth: "10G/10G",
    lastLogoutTime: "N/A",
    lastLogoutReason: "N/A",
    onlineDuration: "200d 12h 1m",
    ponPort: "PON-1",
    vlanId: 600,
    oltPort: "EPON-0/1/0",
    lastOfflineRxPower: null,
  ...
  ...Array.from({ length: 15 }).map((_, i) => {
    ...
    const stability: SignalStability = isOffline
      ? "Offline"
      : isDegraded
        ? "Unstable"
        : isHighLoss
...
export const alarms: Alarm[] = [
  {
    ...
    severity: "Critical",
    deviceId: "olt-05",
    deviceName: "OLT-West-02",
    timestamp: "2023-10-25T08:15:00Z",
    description: "Device offline. Power failure detected.",
    acknowledged: false,
  },
  {
    id: "alm-102",
    severity: "Major",
    deviceId: "onu-003",
    deviceName: "ONU (Global Logistics)",
    timestamp: "2023-10-25T09:30:00Z",
    description: "High optical attenuation (-28.4 dBm)",
    acknowledged: false,
  },
  {
    id: "alm-103",
    ...
    description: "Uplink port utilization > 80%",
    acknowledged: true,
  },
  {
    id: "alm-104",
  ...
  },
  {
    ...
    severity: "Major",
    deviceId: "onu-009",
    deviceName: "ONU (Valley High School)",
    timestamp: "2023-10-25T11:10:00Z",
    description: "Signal degradation trend detected",
    acknowledged: false,
  },
  {
    id: "alm-106",
    ...
    deviceId: "olt-05",
    deviceName: "OLT-West-02",
    timestamp: "2023-10-25T08:14:00Z",
  ...
  },
  {
    ...
    deviceId: "sys",
    deviceName: "System",
    timestamp: "2023-10-25T00:01:00Z",
...
export const metrics = {
  ...
  networkUptime:
    olts.length > 0
      ? Math.round(
          (olts.filter((o) => o.status === "Online").length / olts.length) *
            1000,
        ) / 10
      : null,
